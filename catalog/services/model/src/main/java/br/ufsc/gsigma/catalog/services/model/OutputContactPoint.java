...
@Entity
@Table(name = "output_contact_point")
@Root
@Inheritance(strategy = InheritanceType.JOINED)
public class OutputContactPoint implements Serializable {
	...
	public OutputContactPoint() {

	}

	public OutputContactPoint(ConnectableComponent connectableComponent, String name) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OutputContactPoint other = (OutputContactPoint) obj;
		if (id == null) {
			if (other.id != null)
				return false;
