   ...
   <soapenv:Body>
      <int:setRandomServiceAvailabilityCombination>
         <servicePathNumberOfServices>
            ...
            <entry key="/services/ubl/paymentprocess/accountingCustomer/notifyOfPayment" value="0"/>
...
call_service "http://ublservices.d-201603244.ufsc.br:11000/services/UBLServicesAdminService" "setRandomServiceAvailability"
