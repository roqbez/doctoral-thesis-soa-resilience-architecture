...
public class DockerBindingService {

	private static final Logger logger = LoggerFactory.getLogger(DockerBindingService.class);

	private static final String HOSTNAME = ServicesAddresses.BINDING_SERVICE_HOSTNAME;

	private static final int PORT = ServicesAddresses.BINDING_SERVICE_PORT;

	private static final int DEBUG_PORT = ServicesAddresses.BINDING_SERVICE_DEBUG_PORT;

	private static final String MAIN_CLASS = "br.ufsc.gsigma.binding.bootstrap.RunBindingService";

	private static final Pom POM;

	private static final String IMAGE_NAME = "binding-service";

	private static final String CONTAINER_NAME = "binding-service";

	private static final String VOLUME_CONTAINER_PATH;

	private static final String VOLUME_PATH = "db/binding";

	static {
		try {
			POM = MavenUtil.getPOMFromFile(MavenPOMLocation.POM_SERVICES_BINDING);
