...
public class DockerResilienceService {

	private static final Logger logger = LoggerFactory.getLogger(DockerResilienceService.class);

	private static final String HOSTNAME = ServicesAddresses.RESILIENCE_SERVICE_HOSTNAME;

	private static final int PORT = ServicesAddresses.RESILIENCE_SERVICE_PORT;

	private static final int DEBUG_PORT = ServicesAddresses.RESILIENCE_SERVICE_DEBUG_PORT;

	private static final String MAIN_CLASS = "br.ufsc.gsigma.services.resilience.bootstrap.RunResilienceService";

	private static final Pom POM;

	private static final String IMAGE_NAME = "resilience-service";

	private static final String CONTAINER_NAME = "resilience-service";

	private static final String VOLUME_CONTAINER_PATH;

	private static final String VOLUME_PATH = "db/resilience";

	static {
		try {
			POM = MavenUtil.getPOMFromFile(MavenPOMLocation.POM_SERVICES_RESILIENCE);
