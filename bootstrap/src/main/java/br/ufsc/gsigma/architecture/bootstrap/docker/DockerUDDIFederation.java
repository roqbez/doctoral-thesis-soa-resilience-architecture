...
import br.ufsc.gsigma.architecture.bootstrap.BootstrapUDDIFederation;
...
public class DockerUDDIFederation {

	private static final Logger logger = LoggerFactory.getLogger(DockerUDDIFederation.class);

	private static final String HOSTNAME = ServicesAddresses.SERVICE_FEDERATION_UDDI_HOSTNAME;

	private static final int PORT = ServicesAddresses.SERVICE_FEDERATION_UDDI_PORT;

	private static final int DEBUG_PORT = ServicesAddresses.SERVICE_FEDERATION_UDDI_DEBUG_PORT;

	private static final String MAIN_CLASS = BootstrapMainUDDI.MAIN_CLASS;

	private static final String IMAGE_NAME = "service-federation";

	private static final String CONTAINER_NAME = "service-federation";

	private static final Pom POM;

	private static final String VOLUME_CONTAINER_PATH;

	private static final String VOLUME_PATH = "db/uddi/juddi-federation-db";
	...
	private static File createImage(File imageFileName) throws Exception {
		...
		try {
			...
			BootstrapUDDIFederation.prepareFiles(ServicesAddresses.DEFAULT_DOCKER_HTTP_HOST, ServicesAddresses.DEFAULT_DOCKER_HTTP_PORT, confDir);
