...
public class DockerCatalogService {

	private static final Logger logger = LoggerFactory.getLogger(DockerCatalogService.class);

	private static final String HOSTNAME = ServicesAddresses.CATALOG_SERVICE_HOSTNAME;

	private static final int PORT = ServicesAddresses.CATALOG_SERVICE_PORT;

	private static final int DEBUG_PORT = ServicesAddresses.CATALOG_SERVICE_DEBUG_PORT;

	private static final String MAIN_CLASS = "br.ufsc.gsigma.catalog.services.bootstrap.BootstrapCatalogService";

	private static final Pom POM;

	private static final String IMAGE_NAME = "catalog-service";

	private static final String CONTAINER_NAME = "catalog-service";

	private static final String VOLUME_CONTAINER_PATH;

	private static final String VOLUME_PATH = "db/catalog-persistence";

	static {
		try {
			POM = MavenUtil.getPOMFromFile(MavenPOMLocation.POM_SERVICES_CATALOG_BOOTSTRAP);
