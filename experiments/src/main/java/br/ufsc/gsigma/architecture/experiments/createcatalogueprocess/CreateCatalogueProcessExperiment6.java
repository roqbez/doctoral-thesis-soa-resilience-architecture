...
public class CreateCatalogueProcessExperiment6 extends AbstractCreateCatalogueProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new CreateCatalogueProcessExperiment6().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
	...
	protected Map<String, Integer> getServicesPathAvailability() {
		...
		servicePath.put("/services/ubl/createcatalogueprocess/providerParty/produceCatalogue", 0);
