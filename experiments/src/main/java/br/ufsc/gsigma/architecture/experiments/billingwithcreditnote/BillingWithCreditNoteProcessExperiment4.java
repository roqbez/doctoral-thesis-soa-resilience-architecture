...
public class BillingWithCreditNoteProcessExperiment4 extends AbstractBillingWithCreditNoteProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new BillingWithCreditNoteProcessExperiment4().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
