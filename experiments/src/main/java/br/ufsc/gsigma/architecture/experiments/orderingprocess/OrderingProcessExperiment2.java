...
public class OrderingProcessExperiment2 extends AbstractOrderingProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new OrderingProcessExperiment2().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
	...
	protected Map<String, Integer> getServicesPathAvailability() {
		...
		servicePath.put("/services/ubl/orderingprocess/sellerParty/processOrder", 1);
		servicePath.put("/services/ubl/orderingprocess/sellerParty/acceptOrder", 1);

		// Partner 2
		servicePath.put("/services/ubl/orderingprocess/sellerParty/addDetail", 1);
