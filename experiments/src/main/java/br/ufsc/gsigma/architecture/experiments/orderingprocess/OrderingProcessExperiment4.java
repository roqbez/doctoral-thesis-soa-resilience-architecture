...
public class OrderingProcessExperiment4 extends AbstractOrderingProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new OrderingProcessExperiment4().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
