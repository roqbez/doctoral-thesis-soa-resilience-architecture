...
public class FulfilmentWithReceiptAdviceProcessExperiment5 extends AbstractFulfilmentWithReceiptAdviceProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new FulfilmentWithReceiptAdviceProcessExperiment5().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
