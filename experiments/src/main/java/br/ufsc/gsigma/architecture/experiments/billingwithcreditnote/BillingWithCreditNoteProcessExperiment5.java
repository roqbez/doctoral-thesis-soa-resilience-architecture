...
public class BillingWithCreditNoteProcessExperiment5 extends AbstractBillingWithCreditNoteProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new BillingWithCreditNoteProcessExperiment5().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
