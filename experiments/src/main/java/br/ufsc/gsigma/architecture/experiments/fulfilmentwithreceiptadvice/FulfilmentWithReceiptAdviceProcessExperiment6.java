...
public class FulfilmentWithReceiptAdviceProcessExperiment6 extends AbstractFulfilmentWithReceiptAdviceProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new FulfilmentWithReceiptAdviceProcessExperiment6().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
	...
	protected Map<String, Integer> getServicesPathAvailability() {
		...
		servicePath.put("/services/ubl/fulfilmentwithreceiptadvice/buyerParty/determineAction", 0);
		servicePath.put("/services/ubl/fulfilmentwithreceiptadvice/buyerParty/acceptItems", 1);
		servicePath.put("/services/ubl/fulfilmentwithreceiptadvice/buyerParty/adjustOrder", 0);
