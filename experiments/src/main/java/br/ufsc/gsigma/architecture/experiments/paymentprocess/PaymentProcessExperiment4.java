...
public class PaymentProcessExperiment4 extends AbstractPaymentProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new PaymentProcessExperiment4().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
