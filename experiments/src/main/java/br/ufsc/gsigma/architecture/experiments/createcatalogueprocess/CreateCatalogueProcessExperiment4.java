...
public class CreateCatalogueProcessExperiment4 extends AbstractCreateCatalogueProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new CreateCatalogueProcessExperiment4().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
