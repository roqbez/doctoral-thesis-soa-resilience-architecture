...
public class PaymentProcessExperiment5 extends AbstractPaymentProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new PaymentProcessExperiment5().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
