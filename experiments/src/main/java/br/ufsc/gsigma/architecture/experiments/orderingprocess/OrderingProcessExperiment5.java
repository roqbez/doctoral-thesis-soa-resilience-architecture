...
public class OrderingProcessExperiment5 extends AbstractOrderingProcessExperiment {
	...
	public static void main(String[] args) throws Exception {
		new OrderingProcessExperiment5().executeInternal(new ExecutionExperimentParams(EXECUTION_ID, REPEATS, true, true, null, null));
	}
