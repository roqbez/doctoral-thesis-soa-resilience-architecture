 ...
 *         &lt;element name="output" type="{urn:oasis:names:specification:ubl:schema:xsd:CatalogueRequest-2}CatalogueRequestType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "reviseContentAsyncCallback")
public class ReviseContentAsyncCallback {

    @XmlElement(required = true)
    protected ProcessContext processContext;
    @XmlElement(required = true, nillable = true)
    protected CatalogueRequestType output;
     ...
     *     
     */
    public CatalogueRequestType getOutput() {
        return output;
    }
     ...
     *     
     */
    public void setOutput(CatalogueRequestType value) {
        this.output = value;
    }
