...
@XmlRootElement(name = "acceptItemsAsyncCallback")
public class AcceptItemsAsyncCallback {

    @XmlElement(required = true)
    protected ProcessContext processContext;
    @XmlElement(required = true, nillable = true)
    protected OrderType outputOrder;
     ...
     *     
     */
    public OrderType getOutputOrder() {
        return outputOrder;
    }
     ...
     *     
     */
    public void setOutputOrder(OrderType value) {
