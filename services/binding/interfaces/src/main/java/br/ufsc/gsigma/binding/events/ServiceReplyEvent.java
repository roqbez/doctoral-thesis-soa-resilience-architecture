...
public class ServiceReplyEvent extends Event {
	...
	public ServiceReplyEvent(QName processId, String processName, String processInstanceId, String applicationId, InvokedServiceInfo invokedServiceInfo, String requestCorrelationId) {
